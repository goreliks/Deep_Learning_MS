...
def run_experiment(
    ...
    **kw,
    ...
    # ====== YOUR CODE: ======
    # Data - use DataLoader
    dl_train = torch.utils.data.DataLoader(ds_train, batch_size=batches, shuffle=False)
    dl_test = torch.utils.data.DataLoader(ds_test, batch_size=batches, shuffle=False)
