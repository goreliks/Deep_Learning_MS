...
class YourCodeNet(ConvClassifier):
    ...
    def _make_feature_extractor(self):
        ...
        for index in range(last):
            ...
            layers.append(ResidualBlock(in_channels=curr_channels, channels=self.channels[start_index: end_index],
                                        kernel_sizes=[3] * self.pool_every, batchnorm=True, dropout=0.0))
        ...
        if remainder != 0:
            layers.append(ResidualBlock(in_channels=curr_channels, channels=self.channels[channels_length - remainder:],
                                        kernel_sizes=[3] * remainder, batchnorm=True, dropout=0.0))
